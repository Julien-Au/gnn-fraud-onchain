"""Smoke test for the supervised domain-adversarial GNN (gnn tier)."""
...
from gnn_fraud.train.dann_trainer import train_dann  # noqa: E402
...
def test_train_dann_smoke() -> None:
    data, ts = _synthetic()
    out = train_dann(data, ts, epochs=5, patience=5, seed=0, val_start=30)
